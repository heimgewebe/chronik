...
- leitstand/
  ...
  - merges/
    - leitstand_merge_2510262237__.github_workflows.md
    - leitstand_merge_2510262237__data.md
    - leitstand_merge_2510262237__demo.md
    - leitstand_merge_2510262237__docs.md
    - leitstand_merge_2510262237__docs_adr.md
    - leitstand_merge_2510262237__index.md
    - leitstand_merge_2510262237__part001.md
    - leitstand_merge_2510262237__root.md
    - leitstand_merge_2510262237__scripts.md
    - leitstand_merge_2510262237__tests_fixtures.md
    - leitstand_merge_2510262237__tests_fixtures_aussen.md
    - leitstand_merge_2510262238__index.md
  - scripts/
    - ingest_append.py
    - panel_dump.sh
    - push_leitstand.sh
...
- .env.example → `leitstand_merge_2510262238__root.md`
- .gitignore → `leitstand_merge_2510262238__root.md`
- LICENSE → `leitstand_merge_2510262238__root.md`
- Makefile → `leitstand_merge_2510262238__root.md`
- README.md → `leitstand_merge_2510262238__root.md`
- app.py → `leitstand_merge_2510262238__root.md`
- requirements.txt → `leitstand_merge_2510262238__root.md`
- storage.py → `leitstand_merge_2510262238__root.md`
- test_app.py → `leitstand_merge_2510262238__root.md`
- tests/fixtures/.gitkeep → `leitstand_merge_2510262238__tests_fixtures.md`
- tests/fixtures/aussen/sample-ok.jsonl → `leitstand_merge_2510262238__tests_fixtures_aussen.md`
- demo/.gitkeep → `leitstand_merge_2510262238__demo.md`
- docs/api.md → `leitstand_merge_2510262238__docs.md`
- docs/architecture.md → `leitstand_merge_2510262238__docs.md`
- docs/aussen.event.schema.json → `leitstand_merge_2510262238__docs.md`
- docs/cli-curl.md → `leitstand_merge_2510262238__docs.md`
- docs/event-contracts.md → `leitstand_merge_2510262238__docs.md`
- docs/mitschreiber-ingest.md → `leitstand_merge_2510262238__docs.md`
- docs/operations.md → `leitstand_merge_2510262238__docs.md`
- docs/adr/0001-python-fastapi-panels.md → `leitstand_merge_2510262238__docs_adr.md`
- docs/adr/0002-data-jsonl-per-domain.md → `leitstand_merge_2510262238__docs_adr.md`
- docs/adr/README.md → `leitstand_merge_2510262238__docs_adr.md`
- .github/workflows/validate-aussen-fixtures.yml → `leitstand_merge_2510262238__.github_workflows.md`
- .github/workflows/validate-leitstand-fixtures.yml → `leitstand_merge_2510262238__.github_workflows.md`
- merges/leitstand_merge_2510262237__.github_workflows.md → `leitstand_merge_2510262238__merges.md`
- merges/leitstand_merge_2510262237__data.md → `leitstand_merge_2510262238__merges.md`
- merges/leitstand_merge_2510262237__demo.md → `leitstand_merge_2510262238__merges.md`
- merges/leitstand_merge_2510262237__docs.md → `leitstand_merge_2510262238__merges.md`
- merges/leitstand_merge_2510262237__docs_adr.md → `leitstand_merge_2510262238__merges.md`
- merges/leitstand_merge_2510262237__index.md → `leitstand_merge_2510262238__merges.md`
- merges/leitstand_merge_2510262237__part001.md → `leitstand_merge_2510262238__merges.md`
- merges/leitstand_merge_2510262237__root.md → `leitstand_merge_2510262238__merges.md`
- merges/leitstand_merge_2510262237__scripts.md → `leitstand_merge_2510262238__merges.md`
- merges/leitstand_merge_2510262237__tests_fixtures.md → `leitstand_merge_2510262238__merges.md`
- merges/leitstand_merge_2510262237__tests_fixtures_aussen.md → `leitstand_merge_2510262238__merges.md`
- scripts/ingest_append.py → `leitstand_merge_2510262238__scripts.md`
- scripts/panel_dump.sh → `leitstand_merge_2510262238__scripts.md`
- scripts/push_leitstand.sh → `leitstand_merge_2510262238__scripts.md`
- data/.gitignore → `leitstand_merge_2510262238__data.md`
